...
const MessagesScreen = () => {
  ...
  const sendMessage = () => {
    if (newMessage.trim() && selectedConversation) {
      ...
      // Also update selectedConversation (so modal shows it too)
        ...
        {selectedConversation && (
          <SafeAreaView className="flex-1">
                ...
                {selectedConversation.messages.map((message) => (
                  ...
                  >
                    ...
                    <View className={`flex-1 ${message.fromUser ? "items-end" : ""}`}>
                      ...
                      >
                        <Text className={message.fromUser ? "text-white" : "text-gray-500"}>
                          {message.text}
                        </Text>
                      </View>
            ...
            <KeyboardAvoidingView
              ...
              keyboardVerticalOffset={90} // You can tweak this value
            >
